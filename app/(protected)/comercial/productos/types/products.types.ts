...
export type ProductFilters = {
  ...
  product_type: "all" | "product" | "service";
};

export const DEFAULT_PRODUCT_FILTERS: ProductFilters = {
  search: "", category: "", status: "all", product_type: "all",
};
...
export const SERVICE_UNITS = ["servicio", "hora", "día"];
...
export type ProductModuleLink = {
  ...
  description: string;
  field:       string;
  only?:       ProductType; // si está definido, solo aplica a ese tipo
};
...
export const PRODUCT_MODULE_LINKS: ProductModuleLink[] = [
  ...
  { module: "carta_porte",       label: "Carta Porte",       description: "Fracción arancelaria y país de origen",                         field: "tariff_code, country_of_origin",  only: "product" },
  { module: "comercio_exterior", label: "Comercio Exterior", description: "Fracción arancelaria para complemento CFDI",                   field: "tariff_code, tariff_description", only: "product" },
  { module: "compras",           label: "Compras / Costos",  description: "Costo actualizado desde órdenes de compra",                    field: "cost",                            only: "product" },
  { module: "inventario",        label: "Inventario",        description: "Stock disponible desde recepciones y ajustes",                 field: "stock, stock_min",                only: "product" },
];

// CSV headers para import/export
export const CSV_HEADERS = [
  "sku", "name", "description", "category", "product_type", "unit",
  "unit_price", "cost", "currency", "tax_rate", "stock", "stock_min", "is_active",
