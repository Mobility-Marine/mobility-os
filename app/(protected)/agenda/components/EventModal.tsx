...
import { CalendarEvent, EventFormData, DEFAULT_FORM, EVENT_TYPES, PRIORITIES, STATUSES, VISIBILITIES } from "../types/agenda.types";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* COLOR STRIP */}
        <div style={{ height: "4px", borderRadius: "var(--radius-full)", background: form.color, marginBottom: "20px", opacity: 0.8 }} />
            ...
            <Field label="Color">
              <div style={{ display: "flex", alignItems: "center", gap: "8px", height: "36px" }}>
                <input
                  ...
                  style={{ width: "36px", height: "36px", border: "1px solid var(--color-border)", borderRadius: "var(--radius-md)", cursor: "pointer", padding: "2px" }}
                />
                <div style={{ flex: 1, height: "36px", borderRadius: "var(--radius-md)", background: form.color, opacity: 0.7 }} />
              </div>
            </Field>
          </div>
